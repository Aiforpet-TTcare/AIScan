...
By leveraging advanced machine learning algorithms, AIScan provides accurate and fast diagnostics to help ensure the health and well-being of pets. 
  ...
  spec.source       = { :git => "https://github.com/Aiforpet-TTcare/AIScan.git", :tag => "1.2.2-test" }
  ...
  spec.frameworks = 'UIKit', 'AVFoundation' # AVFAudio를 여기서 뺍니다
  spec.weak_frameworks = 'AVFAudio'       # AVFAudio를 여기로 옮깁니다
