Pod::Spec.new do |spec|
  spec.name         = "AIScan"
  spec.version      = "3.0.7"
  spec.summary      = "AI module for diagnosing dogs (eyes, teeth, skin) and cats (eyes, teeth)."
...
By leveraging advanced machine learning algorithms, AIScan provides accurate and fast diagnostics to help ensure the health and well-being of pets. 
  ...
  spec.source       = { :git => "https://github.com/Aiforpet-TTcare/AIScan.git", :tag => "3.0.7" }
  spec.swift_versions = ['5.9', '5.10', '6.0']
  spec.user_target_xcconfig = {
    'ALWAYS_EMBED_SWIFT_STANDARD_LIBRARIES' => 'YES'
  }
  spec.vendored_frameworks = 'AIScanCore.xcframework'
  spec.source_files = 'Sources/AIScan/**/*.swift', 'Sources/AIScanCameraUI/**/*.swift', 'Sources/AIScanReferenceUI/**/*.swift'
  spec.resource_bundles = {
    'AIScanCameraUIResources' => [
      'Sources/AIScanCameraUI/PrivacyInfo.xcprivacy',
      'Sources/AIScanCameraUI/Resources/*.lproj/*.strings'
    ],
    'AIScanReferenceUIResources' => [
      ...
      'Sources/AIScanCameraUI/ReferenceResources/PDF/**/*'
    ]
  }
end
